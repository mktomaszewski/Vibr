...
static NSString * const kClientId = @"9cb5222bebe34dd492d3994e7c360840";
static NSString * const kCallbackURL = @"vibr://callback";
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
  ...
  [self setupSpotifySDK];
  
  return YES;
}

- (void)setupSpotifySDK
{
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "de.vibr.vibr.Vibr" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Vibr" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Vibr.sqlite"];
    NSError *error = nil;
...
-(BOOL)application:(UIApplication *)application openURL:(NSURL *)url sourceApplication:(NSString *)sourceApplication annotation:(id)annotation {
  ...
  SPTAuthCallback authCallback = ^(NSError *error, SPTSession *session) {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"urlHandled" object:nil];
    
    [[AFAppDotNetAPIClient sharedClient] POST:@"app/tokentest"
                                   parameters:@{ @"token" : session.accessToken}
